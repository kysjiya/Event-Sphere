...
export default function AllExhibitorsRequests() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Exhibitors Booth Requests</h1>
        ...
        <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow">
          ...
          <tbody>
            {exhibitors.map((exhibitor) => (
              <tr key={exhibitor._id} className="border-t hover:bg-gray-50">
                ...
                <td className="py-2 px-4">{exhibitor.booth?.number || 'N/A'}</td>
                <td className="py-2 px-4">
